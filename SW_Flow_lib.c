...
01/26/2016 (CTD) In the function surface_temperature_under_snow(), used Parton's Eq. 5 & 6 from 1998 paper instead of koren paper
...
/**
	* calculates the water intercepted by grasses
	*
	* @author drs
	*
	* @param pptleft the amount of precipitation that is left
	* @param wintgrass the water intercepted by grasses
	* @param ppt the amount of precipitation for the day
	* @param vegcov the vegetation cover for the day based on monthly biomass
	* @param scale
	* @param a
	* @param b
	* @param c
...
/**
 	* calculates the water intercepted by shrubs
	*
	* @author drs
	*
	* @param pptleft the amount of precipitation left
	* @param wintshrub the amount of water intercepted by shrubs
	* @param scale
	* @param a
	* @param b
	* @param c
...
/**
	* calculates the water intercepted by forests
	*
	* @author drs
	*
	* @param pptleft the amount of precipiation left
	* @param wintfor the amount of water intercepted by forests
	* @param ppt the amount of precipitation for the day (cm)
	* @param LAI the forest LAI in cm/cm
	* @param scale
	* @param a
	* @param b
	* @param c
...
/**
  * calculates the water intercepted by forbs
	*
	* @author clk
	*
	* @param pptleft the amount of precipiation left
	* @param wintforb the amount of water intercepted by forbs
	* @param ppt the amount of precipitation for the day (cm)
	* @param vegcov the amount of vegetation cover for the day
	* @param scale
	* @param a
	* @param b
	* @param c
...
/**
  * calculates the water intercepted by litter
	*
	* @author SLC
	*
	* @param pptleft the amount of precipitation left
	* @param wintlit the amount of water intercepted by litter
	* @param blitter the amount of litter for the day
	* @param scale
	* @param a
	* @param b
	* @param c
...
/**
  * simulates infiltration of the soil layers when water conditions are high
	*
	* @author SLC
	*
	* @param swc the soilwater content before drainage
	* @param drain the drainage from the soil layers
	* @param drainout
	* @param pptleft the amount of precipitation left
	* @param nlyrs the number of soil layers to drain from
	* @param swcfc the soilwater content when at field capacity
	* @param swcsat
	* @param impermeability
	* @param standingWater
	*/
...
/**
 * Determines the average temperature of the soil surface under snow
...
// VWCnew: why 0.5 and not 1? and they use a fixed alpha * K whereas here it is 1/(cs * sh)
		if (GT(parts, 1.0)) {//Criterion for a stable solution
			#ifndef RSOILWAT
				printf("\nSOIL_TEMP FUNCTION ERROR: solution is not stable: %f > 1.0... soil temperature will NOT be calculated - check matric densities\n", parts);
			#else
				Rprintf("\nSOIL_TEMP FUNCTION ERROR: solution is not stable: %f > 1.0... soil temperature will NOT be calculated - check matric densities\n", parts);
			#endif
